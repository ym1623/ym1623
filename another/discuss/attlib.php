...
<div id="media-upload-header">
	<span><a href="attachment.php?action=selectFile&logid=<?php echo $logid; ?>">上传附件</a></span>
	<span id="curtab"><a href="attachment.php?action=attlib&logid=<?php echo $logid; ?>">附件库（<?php echo @$attachnum; ?>）</a></span>
</div>
