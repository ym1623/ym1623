...
<form action="add_reply2.php" method="post" id="postComment">
...
<textarea id="detail" name="detail" cols="100" rows="8" style="width:719px; height:400px;"><?php echo $row2['reply_detail'];?></textarea>
